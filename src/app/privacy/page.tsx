...
import { Shield, Lock, Eye, CheckCircle2, Server, FileKey } from 'lucide-react';
...
export default function Privacy() {
    ...
    useEffect(() => {
        ...
        }, 1200); // Show for 1.2s before animating out
    ...
    const protocols = [
        {
            ...
            status: "Minimized",
            icon: Eye,
            description: "We collect only the essential digital identifiers required to deliver high-performance trading insights and personalized interface configurations. Every byte collected is subject to strict residency and minimization standards."
        },
        {
            id: "02",
            title: "Vault-Grade Encryption",
            status: "AES-256",
            icon: Lock,
            description: "Utilizing AES-256 at rest and TLS 1.3 in transit, your data exists within a hardened digital environment. We treat privacy not as a setting, but as the foundational architecture of our platform."
        },
        {
            id: "03",
            title: "Third-Party Zero-Exposure",
            status: "Verified",
            icon: Shield,
            description: "Your behavioral data and personal identifiers are never commercialized. We maintain a zero-exposure policy, ensuring that your digital footprint remains exclusively under your sovereignty."
        },
        {
            id: "04",
            ...
            status: "Global",
            icon: Server,
            description: "Our distributed ledger architecture ensures your data remains compliant with regional sovereignty laws, routing through local nodes to minimize latency and legal exposure."
        }
    ];
        ...
        <main className="relative min-h-screen bg-background text-foreground selection:bg-primary/30 font-sans overflow-x-hidden transition-colors duration-500">
            ...
            <div className="relative pt-32 pb-20 px-6 md:px-12 max-w-5xl mx-auto">
                ...
                <motion.div
                    ...
                    transition={{ duration: 0.8, delay: 1.5 }} // Delay content until landing is mostly done
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground font-medium max-w-2xl leading-relaxed">
                        Architectural safeguards and cryptographic standards protecting your <span className="text-foreground">digital sovereignty</span>.
                    </p>
                </motion.div>
                ...
                <div className="space-y-4">
                    {protocols.map((item, i) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ delay: 1.6 + (i * 0.1), duration: 0.5 }} // Stagger start after landing
